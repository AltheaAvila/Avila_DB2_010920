...
CREATE TABLE "010920".CLASS (CLASS_CODE varchar(5),
CRS_CODE varchar(10),CLASS_SECTION varchar(2),
...
/* -- */
CREATE TABLE "010920".COURSE (CRS_CODE varchar(10),
...
CREATE TABLE "010920".EMPLOYEE (EMP_NUM int,EMP_LNAME varchar(15),
...
CREATE TABLE "010920".ENROLL (CLASS_CODE varchar(5),
STU_NUM int,
...
EMP_NUM int,DEPT_CODE varchar(10),
